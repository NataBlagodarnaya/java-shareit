...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findByBooker_IdAndStartIsBeforeAndEndIsAfter(Long bookerId, LocalDateTime nowStart, LocalDateTime nowEnd, Sort sort);
    ...
    List<Booking> findByItem_Owner_IdAndStartIsBeforeAndEndIsAfter(Long ownerId, LocalDateTime nowStart, LocalDateTime nowEnd, Sort sort);
    ...
    Optional<Booking> findFirstByItem_IdAndStatusNotAndStartBeforeOrderByStartDesc(
            Long itemId, BookingStatus status, LocalDateTime now);

    Optional<Booking> findFirstByItem_IdAndStatusNotAndStartAfterOrderByStartAsc(
            Long itemId, BookingStatus status, LocalDateTime now);
